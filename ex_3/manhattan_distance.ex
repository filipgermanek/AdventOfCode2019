defmodule ManhattanDistance do
  def temp(direction, x, y, value, finalValue, elements) do
    cond do
      direction == "R" -> createPoint(direction, x + 1, y, value + 1, finalValue, elements ++ [[x, y]])
      direction == "L" -> createPoint(direction, x - 1 , y, value + 1, finalValue, elements ++ [[x, y]])
      direction == "U" -> createPoint(direction, x, y + 1 , value + 1, finalValue, elements ++ [[x, y]])
      direction == "D" -> createPoint(direction, x, y - 1, value + 1, finalValue, elements ++ [[x, y]])
    end
  end

  def createPoint(direction, x, y, value, finalValue, elements) do
    cond do
      value < finalValue -> temp(direction, x, y, value, finalValue, elements)
  ...
  #  IO.inspect(elements)
    newElements = createPoint(direction, x, y, 0, value, elements)
