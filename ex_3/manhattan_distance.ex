defmodule ManhattanDistance do
  ...
  def produceVisitedPointsForWireInput(visitedPointsMap, inputArray, index, x, y) do
    ...
    modifiedMap = populateMapWithVisitedPoints(visitedPointsMap, direction, value, x, y, 1)
  ...
  def populateMapWithVisitedPoints(pointsMap, direction, value, previousX, previousY, iterator) do
    key = getPointKey(direction, previousX, previousY, iterator)
    modifiedMap = Map.put(pointsMap, key, true)
    if iterator <= value do
      populateMapWithVisitedPoints(modifiedMap, direction, value, previousX, previousY, iterator+1)
    else
      modifiedMap
    end
  end
